...
<meta property="og:image"  content="{{Helpers::CacheImageLink($single->data->dynamic->header_resim,array('ThumbsMode' => false, 'Mime' => 'webp'))}}" />
...
<meta name="twitter:image" content="{{Helpers::CacheImageLink($single->data->dynamic->header_resim,array('ThumbsMode' => false, 'Mime' => 'webp'))}}">
<!-- Creaati SEO TOOLS -->
<!-- Creaati SEO TOOLS -->
    ...
    <script type="application/ld+json">
{
  ...
  "image": "{{Helpers::CacheImageLink($single->data->dynamic->header_resim,array('ThumbsMode' => false, 'Mime' => 'webp'))}}",
  "author": {
    "@type": "Person",
